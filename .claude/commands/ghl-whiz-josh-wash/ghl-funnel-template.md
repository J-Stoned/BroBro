...
examples:
  - "/ghl-funnel-template for appointment reminder automation"
  - "/ghl-funnel-template with multichannel SMS + Email"
  - "/ghl-funnel-template using Josh Wash proven workflow patterns"
category: templates
...
---
# Funnel Template - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Funnel Template** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Funnel Template
...
Extract the user's goal from their input after `/ghl-funnel-template`.
...
If unclear, ask: "What would you like to accomplish with funnel template?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `funnel template multichannel automation best practices`
