...
examples:
  - "/ghl-subscription-management for appointment reminder automation"
  - "/ghl-subscription-management with multichannel SMS + Email"
  - "/ghl-subscription-management using Josh Wash proven workflow patterns"
category: ecommerce
tags: ["ecommerce", "automation", "josh-wash", "multichannel"]
josh_wash_workflow: "Maintenance Club Purchase Confirmation"
proven_pattern: "trigger: purchase → multichannel (SMS + Email) → membership actions"
---
# Subscription Management - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Subscription Management** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.

## 🎯 Josh Wash Proven Workflow Applied

**Workflow:** Maintenance Club Purchase Confirmation
...
```
trigger: purchase → multichannel (SMS + Email) → membership actions
```
...
### M = Map: Pattern Applied to Subscription Management
...
Extract the user's goal from their input after `/ghl-subscription-management`.
...
If unclear, ask: "What would you like to accomplish with subscription management?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `subscription management multichannel automation best practices`
- Focus: Proven conversion tactics from Josh Wash workflows

**Query 2 - Josh Wash Tutorials:**
Search `ghl-tutorials` collection:
- Query: `maintenance club purchase confirmation setup tutorial`
...
- Exact workflow from Josh Wash's Maintenance Club Purchase Confirmation
- Validated success metrics: membership_activation=95%, first_booking_rate=68%, retention_30day=91%
...
## Josh Wash Proven Workflow: Maintenance Club Purchase Confirmation
...
```
Deploying "Maintenance Club Purchase Confirmation" to your GHL account...
...
**Remember:** This workflow is proven with 95% success rate at Josh Wash Pressure Washing. Deploy as-is for best results, then customize based on your specific business needs.

**🚀 Ready to deploy Josh Wash's proven Maintenance Club Purchase Confirmation workflow? Use MCP tools or save JSON for manual implementation.**
