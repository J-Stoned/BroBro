...
examples:
  - "/ghl-calendar-sync for appointment reminder automation"
  - "/ghl-calendar-sync with multichannel SMS + Email"
  - "/ghl-calendar-sync using Josh Wash proven workflow patterns"
...
---
# Calendar Sync - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Calendar Sync** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Calendar Sync
...
Extract the user's goal from their input after `/ghl-calendar-sync`.
...
If unclear, ask: "What would you like to accomplish with calendar sync?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `calendar sync multichannel automation best practices`
