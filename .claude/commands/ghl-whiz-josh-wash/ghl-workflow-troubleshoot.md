...
examples:
  - "/ghl-workflow-troubleshoot for appointment reminder automation"
  - "/ghl-workflow-troubleshoot with multichannel SMS + Email"
  - "/ghl-workflow-troubleshoot using Josh Wash proven workflow patterns"
category: workflow
...
---
# Workflow Troubleshoot - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Troubleshoot** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Troubleshoot
...
Extract the user's goal from their input after `/ghl-workflow-troubleshoot`.
...
If unclear, ask: "What would you like to accomplish with workflow troubleshoot?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow troubleshoot multichannel automation best practices`
