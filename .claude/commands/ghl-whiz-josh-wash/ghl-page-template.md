...
examples:
  - "/ghl-page-template for appointment reminder automation"
  - "/ghl-page-template with multichannel SMS + Email"
  - "/ghl-page-template using Josh Wash proven workflow patterns"
category: templates
...
---
# Page Template - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Page Template** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Page Template
...
Extract the user's goal from their input after `/ghl-page-template`.
...
If unclear, ask: "What would you like to accomplish with page template?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `page template multichannel automation best practices`
