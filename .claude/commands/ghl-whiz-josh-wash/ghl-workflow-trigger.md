...
examples:
  - "/ghl-workflow-trigger for appointment reminder automation"
  - "/ghl-workflow-trigger with multichannel SMS + Email"
  - "/ghl-workflow-trigger using Josh Wash proven workflow patterns"
category: workflow
...
---
# Workflow Trigger - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Trigger** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Trigger
...
Extract the user's goal from their input after `/ghl-workflow-trigger`.
...
If unclear, ask: "What would you like to accomplish with workflow trigger?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow trigger multichannel automation best practices`
