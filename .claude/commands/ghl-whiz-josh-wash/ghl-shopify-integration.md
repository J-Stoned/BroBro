...
examples:
  - "/ghl-shopify-integration for appointment reminder automation"
  - "/ghl-shopify-integration with multichannel SMS + Email"
  - "/ghl-shopify-integration using Josh Wash proven workflow patterns"
...
---
# Shopify Integration - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Shopify Integration** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Shopify Integration
...
Extract the user's goal from their input after `/ghl-shopify-integration`.
...
If unclear, ask: "What would you like to accomplish with shopify integration?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `shopify integration multichannel automation best practices`
