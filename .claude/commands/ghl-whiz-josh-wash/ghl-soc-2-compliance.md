...
examples:
  - "/ghl-soc-2-compliance for appointment reminder automation"
  - "/ghl-soc-2-compliance with multichannel SMS + Email"
  - "/ghl-soc-2-compliance using Josh Wash proven workflow patterns"
category: compliance
...
---
# Soc 2 Compliance - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Soc 2 Compliance** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Soc 2 Compliance
...
Extract the user's goal from their input after `/ghl-soc-2-compliance`.
...
If unclear, ask: "What would you like to accomplish with soc 2 compliance?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `soc 2 compliance multichannel automation best practices`
