...
examples:
  - "/ghl-certification-prep for appointment reminder automation"
  - "/ghl-certification-prep with multichannel SMS + Email"
  - "/ghl-certification-prep using Josh Wash proven workflow patterns"
category: learning
...
---
# Certification Prep - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Certification Prep** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Certification Prep
...
Extract the user's goal from their input after `/ghl-certification-prep`.
...
If unclear, ask: "What would you like to accomplish with certification prep?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `certification prep multichannel automation best practices`
