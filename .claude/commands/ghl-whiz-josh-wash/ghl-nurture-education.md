...
examples:
  - "/ghl-nurture-education for appointment reminder automation"
  - "/ghl-nurture-education with multichannel SMS + Email"
  - "/ghl-nurture-education using Josh Wash proven workflow patterns"
category: lead
...
---
# Nurture Education - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Nurture Education** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Nurture Education
...
If unclear, ask: "What would you like to accomplish with nurture education?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `nurture education multichannel automation best practices`
