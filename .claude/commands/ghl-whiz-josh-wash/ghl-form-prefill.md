...
examples:
  - "/ghl-form-prefill for appointment reminder automation"
  - "/ghl-form-prefill with multichannel SMS + Email"
  - "/ghl-form-prefill using Josh Wash proven workflow patterns"
category: lead
...
---
# Form Prefill - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Form Prefill** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Form Prefill
...
If unclear, ask: "What would you like to accomplish with form prefill?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `form prefill multichannel automation best practices`
