...
examples:
  - "/ghl-contact-support for appointment reminder automation"
  - "/ghl-contact-support with multichannel SMS + Email"
  - "/ghl-contact-support using Josh Wash proven workflow patterns"
...
---
# Contact Support - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Contact Support** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Contact Support
...
Extract the user's goal from their input after `/ghl-contact-support`.
...
If unclear, ask: "What would you like to accomplish with contact support?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `contact support multichannel automation best practices`
