...
examples:
  - "/ghl-roi-calculation for appointment reminder automation"
  - "/ghl-roi-calculation with multichannel SMS + Email"
  - "/ghl-roi-calculation using Josh Wash proven workflow patterns"
category: reporting
...
---
# Roi Calculation - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Roi Calculation** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Roi Calculation
...
Extract the user's goal from their input after `/ghl-roi-calculation`.
...
If unclear, ask: "What would you like to accomplish with roi calculation?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `roi calculation multichannel automation best practices`
