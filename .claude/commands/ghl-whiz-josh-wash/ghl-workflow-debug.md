...
examples:
  - "/ghl-workflow-debug for appointment reminder automation"
  - "/ghl-workflow-debug with multichannel SMS + Email"
  - "/ghl-workflow-debug using Josh Wash proven workflow patterns"
...
---
# Workflow Debug - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Debug** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Debug
...
Extract the user's goal from their input after `/ghl-workflow-debug`.
...
If unclear, ask: "What would you like to accomplish with workflow debug?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow debug multichannel automation best practices`
