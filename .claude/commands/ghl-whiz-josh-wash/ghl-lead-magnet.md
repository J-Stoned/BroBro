...
examples:
  - "/ghl-lead-magnet for appointment reminder automation"
  - "/ghl-lead-magnet with multichannel SMS + Email"
  - "/ghl-lead-magnet using Josh Wash proven workflow patterns"
category: lead
...
---
# Lead Magnet - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Lead Magnet** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Lead Magnet
...
Extract the user's goal from their input after `/ghl-lead-magnet`.
...
If unclear, ask: "What would you like to accomplish with lead magnet?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `lead magnet multichannel automation best practices`
