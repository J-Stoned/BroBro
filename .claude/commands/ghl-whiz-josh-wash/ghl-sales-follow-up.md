...
examples:
  - "/ghl-sales-follow-up for appointment reminder automation"
  - "/ghl-sales-follow-up with multichannel SMS + Email"
  - "/ghl-sales-follow-up using Josh Wash proven workflow patterns"
category: sales
...
---
# Sales Follow Up - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Sales Follow Up** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Sales Follow Up
...
If unclear, ask: "What would you like to accomplish with sales follow up?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `sales follow up multichannel automation best practices`
