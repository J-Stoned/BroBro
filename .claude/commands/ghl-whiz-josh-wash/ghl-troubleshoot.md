...
examples:
  - "/ghl-troubleshoot for appointment reminder automation"
  - "/ghl-troubleshoot with multichannel SMS + Email"
  - "/ghl-troubleshoot using Josh Wash proven workflow patterns"
...
---
# Troubleshoot - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Troubleshoot** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Troubleshoot
...
Extract the user's goal from their input after `/ghl-troubleshoot`.
...
If unclear, ask: "What would you like to accomplish with troubleshoot?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `troubleshoot multichannel automation best practices`
