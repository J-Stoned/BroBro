...
examples:
  - "/ghl-sms-keywords for appointment reminder automation"
  - "/ghl-sms-keywords with multichannel SMS + Email"
  - "/ghl-sms-keywords using Josh Wash proven workflow patterns"
category: lead
...
---
# Sms Keywords - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Sms Keywords** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Sms Keywords
...
If unclear, ask: "What would you like to accomplish with sms keywords?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `sms keywords multichannel automation best practices`
