...
examples:
  - "/ghl-nurture-re-engagement for appointment reminder automation"
  - "/ghl-nurture-re-engagement with multichannel SMS + Email"
  - "/ghl-nurture-re-engagement using Josh Wash proven workflow patterns"
category: lead
...
---
# Nurture Re Engagement - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Nurture Re Engagement** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Nurture Re Engagement
...
If unclear, ask: "What would you like to accomplish with nurture re engagement?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `nurture re engagement multichannel automation best practices`
