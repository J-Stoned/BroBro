...
examples:
  - "/ghl-pricing-strategy for appointment reminder automation"
  - "/ghl-pricing-strategy with multichannel SMS + Email"
  - "/ghl-pricing-strategy using Josh Wash proven workflow patterns"
category: sales
...
---
# Pricing Strategy - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Pricing Strategy** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Pricing Strategy
...
Extract the user's goal from their input after `/ghl-pricing-strategy`.
...
If unclear, ask: "What would you like to accomplish with pricing strategy?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `pricing strategy multichannel automation best practices`
