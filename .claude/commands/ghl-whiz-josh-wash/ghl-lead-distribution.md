...
examples:
  - "/ghl-lead-distribution for appointment reminder automation"
  - "/ghl-lead-distribution with multichannel SMS + Email"
  - "/ghl-lead-distribution using Josh Wash proven workflow patterns"
category: lead
...
---
# Lead Distribution - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Lead Distribution** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Lead Distribution
...
Extract the user's goal from their input after `/ghl-lead-distribution`.
...
If unclear, ask: "What would you like to accomplish with lead distribution?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `lead distribution multichannel automation best practices`
