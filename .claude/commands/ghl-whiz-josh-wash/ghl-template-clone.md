...
examples:
  - "/ghl-template-clone for appointment reminder automation"
  - "/ghl-template-clone with multichannel SMS + Email"
  - "/ghl-template-clone using Josh Wash proven workflow patterns"
category: templates
...
---
# Template Clone - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Template Clone** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Template Clone
...
Extract the user's goal from their input after `/ghl-template-clone`.
...
If unclear, ask: "What would you like to accomplish with template clone?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `template clone multichannel automation best practices`
