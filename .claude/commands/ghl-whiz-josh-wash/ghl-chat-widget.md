...
examples:
  - "/ghl-chat-widget for appointment reminder automation"
  - "/ghl-chat-widget with multichannel SMS + Email"
  - "/ghl-chat-widget using Josh Wash proven workflow patterns"
category: lead
...
---
# Chat Widget - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Chat Widget** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Chat Widget
...
If unclear, ask: "What would you like to accomplish with chat widget?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `chat widget multichannel automation best practices`
