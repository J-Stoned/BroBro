...
examples:
  - "/ghl-form-conditional for appointment reminder automation"
  - "/ghl-form-conditional with multichannel SMS + Email"
  - "/ghl-form-conditional using Josh Wash proven workflow patterns"
category: lead
...
---
# Form Conditional - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Form Conditional** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Form Conditional
...
If unclear, ask: "What would you like to accomplish with form conditional?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `form conditional multichannel automation best practices`
