...
examples:
  - "/ghl-ad-creative-testing for appointment reminder automation"
  - "/ghl-ad-creative-testing with multichannel SMS + Email"
  - "/ghl-ad-creative-testing using Josh Wash proven workflow patterns"
category: ads
tags: ["ads", "automation", "josh-wash", "multichannel"]
josh_wash_workflow: "Booking Confirmation Email"
proven_pattern: "trigger: booking → immediate Email + hidden actions"
---
# Ad Creative Testing - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Ad Creative Testing** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Ad Creative Testing
...
Extract the user's goal from their input after `/ghl-ad-creative-testing`.
...
If unclear, ask: "What would you like to accomplish with ad creative testing?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `ad creative testing multichannel automation best practices`
