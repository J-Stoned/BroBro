...
examples:
  - "/ghl-email-sequence for appointment reminder automation"
  - "/ghl-email-sequence with multichannel SMS + Email"
  - "/ghl-email-sequence using Josh Wash proven workflow patterns"
category: lead
...
---
# Email Sequence - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Email Sequence** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Email Sequence
...
If unclear, ask: "What would you like to accomplish with email sequence?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `email sequence multichannel automation best practices`
