...
examples:
  - "/ghl-landing-page-design for appointment reminder automation"
  - "/ghl-landing-page-design with multichannel SMS + Email"
  - "/ghl-landing-page-design using Josh Wash proven workflow patterns"
category: lead
...
---
# Landing Page Design - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Landing Page Design** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Landing Page Design
...
If unclear, ask: "What would you like to accomplish with landing page design?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `landing page design multichannel automation best practices`
