...
examples:
  - "/ghl-workflow-template for appointment reminder automation"
  - "/ghl-workflow-template with multichannel SMS + Email"
  - "/ghl-workflow-template using Josh Wash proven workflow patterns"
category: templates
...
---
# Workflow Template - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Template** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Template
...
Extract the user's goal from their input after `/ghl-workflow-template`.
...
If unclear, ask: "What would you like to accomplish with workflow template?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow template multichannel automation best practices`
