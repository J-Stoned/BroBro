...
examples:
  - "/ghl-faq for appointment reminder automation"
  - "/ghl-faq with multichannel SMS + Email"
  - "/ghl-faq using Josh Wash proven workflow patterns"
category: learning
...
---
# Faq - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Faq** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
Extract the user's goal from their input after `/ghl-faq`.
...
If unclear, ask: "What would you like to accomplish with faq?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `faq multichannel automation best practices`
