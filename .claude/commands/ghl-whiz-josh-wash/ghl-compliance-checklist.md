...
examples:
  - "/ghl-compliance-checklist for appointment reminder automation"
  - "/ghl-compliance-checklist with multichannel SMS + Email"
  - "/ghl-compliance-checklist using Josh Wash proven workflow patterns"
category: compliance
tags: ["compliance", "automation", "josh-wash", "multichannel"]
josh_wash_workflow: "Booking Confirmation Email"
proven_pattern: "trigger: booking → immediate Email + hidden actions"
---
# Compliance Checklist - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Compliance Checklist** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Compliance Checklist
...
Extract the user's goal from their input after `/ghl-compliance-checklist`.
...
If unclear, ask: "What would you like to accomplish with compliance checklist?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `compliance checklist multichannel automation best practices`
