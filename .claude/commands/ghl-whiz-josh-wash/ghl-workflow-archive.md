...
examples:
  - "/ghl-workflow-archive for appointment reminder automation"
  - "/ghl-workflow-archive with multichannel SMS + Email"
  - "/ghl-workflow-archive using Josh Wash proven workflow patterns"
category: workflow
...
---
# Workflow Archive - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Archive** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Archive
...
Extract the user's goal from their input after `/ghl-workflow-archive`.
...
If unclear, ask: "What would you like to accomplish with workflow archive?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow archive multichannel automation best practices`
