...
examples:
  - "/ghl-hubspot-integration for appointment reminder automation"
  - "/ghl-hubspot-integration with multichannel SMS + Email"
  - "/ghl-hubspot-integration using Josh Wash proven workflow patterns"
...
---
# Hubspot Integration - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Hubspot Integration** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Hubspot Integration
...
Extract the user's goal from their input after `/ghl-hubspot-integration`.
...
If unclear, ask: "What would you like to accomplish with hubspot integration?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `hubspot integration multichannel automation best practices`
