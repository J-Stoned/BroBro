...
examples:
  - "/ghl-sms-delivery-issues for appointment reminder automation"
  - "/ghl-sms-delivery-issues with multichannel SMS + Email"
  - "/ghl-sms-delivery-issues using Josh Wash proven workflow patterns"
...
---
# Sms Delivery Issues - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Sms Delivery Issues** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Sms Delivery Issues
...
If unclear, ask: "What would you like to accomplish with sms delivery issues?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `sms delivery issues multichannel automation best practices`
