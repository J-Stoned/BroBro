...
examples:
  - "/ghl-stripe-integration for appointment reminder automation"
  - "/ghl-stripe-integration with multichannel SMS + Email"
  - "/ghl-stripe-integration using Josh Wash proven workflow patterns"
...
---
# Stripe Integration - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Stripe Integration** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Stripe Integration
...
Extract the user's goal from their input after `/ghl-stripe-integration`.
...
If unclear, ask: "What would you like to accomplish with stripe integration?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `stripe integration multichannel automation best practices`
