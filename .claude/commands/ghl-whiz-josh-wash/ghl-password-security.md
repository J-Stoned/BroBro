...
examples:
  - "/ghl-password-security for appointment reminder automation"
  - "/ghl-password-security with multichannel SMS + Email"
  - "/ghl-password-security using Josh Wash proven workflow patterns"
category: compliance
...
---
# Password Security - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Password Security** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Password Security
...
Extract the user's goal from their input after `/ghl-password-security`.
...
If unclear, ask: "What would you like to accomplish with password security?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `password security multichannel automation best practices`
