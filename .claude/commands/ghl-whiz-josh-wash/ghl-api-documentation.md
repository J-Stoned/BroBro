...
examples:
  - "/ghl-api-documentation for appointment reminder automation"
  - "/ghl-api-documentation with multichannel SMS + Email"
  - "/ghl-api-documentation using Josh Wash proven workflow patterns"
category: advanced
...
---
# Api Documentation - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Api Documentation** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Api Documentation
...
Extract the user's goal from their input after `/ghl-api-documentation`.
...
If unclear, ask: "What would you like to accomplish with api documentation?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `api documentation multichannel automation best practices`
