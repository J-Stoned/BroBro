...
examples:
  - "/ghl-form-analytics for appointment reminder automation"
  - "/ghl-form-analytics with multichannel SMS + Email"
  - "/ghl-form-analytics using Josh Wash proven workflow patterns"
category: reporting
...
---
# Form Analytics - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Form Analytics** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Form Analytics
...
Extract the user's goal from their input after `/ghl-form-analytics`.
...
If unclear, ask: "What would you like to accomplish with form analytics?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `form analytics multichannel automation best practices`
