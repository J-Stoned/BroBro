...
examples:
  - "/ghl-nurture-social-proof for appointment reminder automation"
  - "/ghl-nurture-social-proof with multichannel SMS + Email"
  - "/ghl-nurture-social-proof using Josh Wash proven workflow patterns"
category: lead
...
---
# Nurture Social Proof - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Nurture Social Proof** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Nurture Social Proof
...
If unclear, ask: "What would you like to accomplish with nurture social proof?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `nurture social proof multichannel automation best practices`
