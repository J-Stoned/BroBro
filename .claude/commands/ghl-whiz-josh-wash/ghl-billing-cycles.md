...
examples:
  - "/ghl-billing-cycles for appointment reminder automation"
  - "/ghl-billing-cycles with multichannel SMS + Email"
  - "/ghl-billing-cycles using Josh Wash proven workflow patterns"
category: ecommerce
...
---
# Billing Cycles - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Billing Cycles** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Billing Cycles
...
Extract the user's goal from their input after `/ghl-billing-cycles`.
...
If unclear, ask: "What would you like to accomplish with billing cycles?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `billing cycles multichannel automation best practices`
