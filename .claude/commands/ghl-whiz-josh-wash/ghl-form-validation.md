...
examples:
  - "/ghl-form-validation for appointment reminder automation"
  - "/ghl-form-validation with multichannel SMS + Email"
  - "/ghl-form-validation using Josh Wash proven workflow patterns"
category: lead
...
---
# Form Validation - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Form Validation** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Form Validation
...
If unclear, ask: "What would you like to accomplish with form validation?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `form validation multichannel automation best practices`
