...
examples:
  - "/ghl-security-audit for appointment reminder automation"
  - "/ghl-security-audit with multichannel SMS + Email"
  - "/ghl-security-audit using Josh Wash proven workflow patterns"
category: compliance
...
---
# Security Audit - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Security Audit** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Security Audit
...
Extract the user's goal from their input after `/ghl-security-audit`.
...
If unclear, ask: "What would you like to accomplish with security audit?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `security audit multichannel automation best practices`
