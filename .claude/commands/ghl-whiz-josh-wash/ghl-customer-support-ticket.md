...
examples:
  - "/ghl-customer-support-ticket for appointment reminder automation"
  - "/ghl-customer-support-ticket with multichannel SMS + Email"
  - "/ghl-customer-support-ticket using Josh Wash proven workflow patterns"
category: customer
...
---
# Customer Support Ticket - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Customer Support Ticket** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Customer Support Ticket
...
Extract the user's goal from their input after `/ghl-customer-support-ticket`.
...
If unclear, ask: "What would you like to accomplish with customer support ticket?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `customer support ticket multichannel automation best practices`
