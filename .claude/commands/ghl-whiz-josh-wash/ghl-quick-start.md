...
examples:
  - "/ghl-quick-start for appointment reminder automation"
  - "/ghl-quick-start with multichannel SMS + Email"
  - "/ghl-quick-start using Josh Wash proven workflow patterns"
category: meta
...
---
# Quick Start - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Quick Start** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Quick Start
...
Extract the user's goal from their input after `/ghl-quick-start`.
...
If unclear, ask: "What would you like to accomplish with quick start?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `quick start multichannel automation best practices`
