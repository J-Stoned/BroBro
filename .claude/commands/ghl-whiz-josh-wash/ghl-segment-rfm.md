...
examples:
  - "/ghl-segment-rfm for appointment reminder automation"
  - "/ghl-segment-rfm with multichannel SMS + Email"
  - "/ghl-segment-rfm using Josh Wash proven workflow patterns"
category: lead
...
---
# Segment Rfm - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Segment Rfm** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Segment Rfm
...
Extract the user's goal from their input after `/ghl-segment-rfm`.
...
If unclear, ask: "What would you like to accomplish with segment rfm?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `segment rfm multichannel automation best practices`
