...
examples:
  - "/ghl-cart-recovery for appointment reminder automation"
  - "/ghl-cart-recovery with multichannel SMS + Email"
  - "/ghl-cart-recovery using Josh Wash proven workflow patterns"
category: ecommerce
...
---
# Cart Recovery - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Cart Recovery** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Cart Recovery
...
Extract the user's goal from their input after `/ghl-cart-recovery`.
...
If unclear, ask: "What would you like to accomplish with cart recovery?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `cart recovery multichannel automation best practices`
