...
examples:
  - "/ghl-api-integration for appointment reminder automation"
  - "/ghl-api-integration with multichannel SMS + Email"
  - "/ghl-api-integration using Josh Wash proven workflow patterns"
...
---
# Api Integration - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Api Integration** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Api Integration
...
Extract the user's goal from their input after `/ghl-api-integration`.
...
If unclear, ask: "What would you like to accomplish with api integration?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `api integration multichannel automation best practices`
