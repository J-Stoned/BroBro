...
examples:
  - "/ghl-client-onboarding for appointment reminder automation"
  - "/ghl-client-onboarding with multichannel SMS + Email"
  - "/ghl-client-onboarding using Josh Wash proven workflow patterns"
category: customer
...
---
# Client Onboarding - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Client Onboarding** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Client Onboarding
...
Extract the user's goal from their input after `/ghl-client-onboarding`.
...
If unclear, ask: "What would you like to accomplish with client onboarding?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `client onboarding multichannel automation best practices`
