...
examples:
  - "/ghl-landing-page-mobile for appointment reminder automation"
  - "/ghl-landing-page-mobile with multichannel SMS + Email"
  - "/ghl-landing-page-mobile using Josh Wash proven workflow patterns"
category: lead
...
---
# Landing Page Mobile - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Landing Page Mobile** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Landing Page Mobile
...
If unclear, ask: "What would you like to accomplish with landing page mobile?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `landing page mobile multichannel automation best practices`
