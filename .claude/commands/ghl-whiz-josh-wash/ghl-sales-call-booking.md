...
examples:
  - "/ghl-sales-call-booking for appointment reminder automation"
  - "/ghl-sales-call-booking with multichannel SMS + Email"
  - "/ghl-sales-call-booking using Josh Wash proven workflow patterns"
category: sales
...
---
# Sales Call Booking - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Sales Call Booking** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Sales Call Booking
...
If unclear, ask: "What would you like to accomplish with sales call booking?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `sales call booking multichannel automation best practices`
