...
examples:
  - "/ghl-landing-page-seo for appointment reminder automation"
  - "/ghl-landing-page-seo with multichannel SMS + Email"
  - "/ghl-landing-page-seo using Josh Wash proven workflow patterns"
category: lead
...
---
# Landing Page Seo - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Landing Page Seo** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Landing Page Seo
...
If unclear, ask: "What would you like to accomplish with landing page seo?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `landing page seo multichannel automation best practices`
