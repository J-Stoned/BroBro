...
examples:
  - "/ghl-churn-prevention for appointment reminder automation"
  - "/ghl-churn-prevention with multichannel SMS + Email"
  - "/ghl-churn-prevention using Josh Wash proven workflow patterns"
category: customer
...
---
# Churn Prevention - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Churn Prevention** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Churn Prevention
...
Extract the user's goal from their input after `/ghl-churn-prevention`.
...
If unclear, ask: "What would you like to accomplish with churn prevention?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `churn prevention multichannel automation best practices`
