...
examples:
  - "/ghl-instagram-ads for appointment reminder automation"
  - "/ghl-instagram-ads with multichannel SMS + Email"
  - "/ghl-instagram-ads using Josh Wash proven workflow patterns"
category: ads
...
---
# Instagram Ads - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Instagram Ads** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Instagram Ads
...
Extract the user's goal from their input after `/ghl-instagram-ads`.
...
If unclear, ask: "What would you like to accomplish with instagram ads?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `instagram ads multichannel automation best practices`
