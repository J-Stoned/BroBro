...
examples:
  - "/ghl-preference-center for appointment reminder automation"
  - "/ghl-preference-center with multichannel SMS + Email"
  - "/ghl-preference-center using Josh Wash proven workflow patterns"
category: content
...
---
# Preference Center - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Preference Center** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Preference Center
...
Extract the user's goal from their input after `/ghl-preference-center`.
...
If unclear, ask: "What would you like to accomplish with preference center?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `preference center multichannel automation best practices`
