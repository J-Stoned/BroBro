...
examples:
  - "/ghl-workflow-logging for appointment reminder automation"
  - "/ghl-workflow-logging with multichannel SMS + Email"
  - "/ghl-workflow-logging using Josh Wash proven workflow patterns"
category: workflow
...
---
# Workflow Logging - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Logging** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Logging
...
Extract the user's goal from their input after `/ghl-workflow-logging`.
...
If unclear, ask: "What would you like to accomplish with workflow logging?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow logging multichannel automation best practices`
