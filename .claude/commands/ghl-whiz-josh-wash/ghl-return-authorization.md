...
examples:
  - "/ghl-return-authorization for appointment reminder automation"
  - "/ghl-return-authorization with multichannel SMS + Email"
  - "/ghl-return-authorization using Josh Wash proven workflow patterns"
category: ecommerce
...
---
# Return Authorization - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Return Authorization** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Return Authorization
...
Extract the user's goal from their input after `/ghl-return-authorization`.
...
If unclear, ask: "What would you like to accomplish with return authorization?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `return authorization multichannel automation best practices`
