...
examples:
  - "/ghl-email-copy for appointment reminder automation"
  - "/ghl-email-copy with multichannel SMS + Email"
  - "/ghl-email-copy using Josh Wash proven workflow patterns"
category: lead
...
---
# Email Copy - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Email Copy** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Email Copy
...
If unclear, ask: "What would you like to accomplish with email copy?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `email copy multichannel automation best practices`
