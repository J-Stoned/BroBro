...
examples:
  - "/ghl-cohort-analysis for appointment reminder automation"
  - "/ghl-cohort-analysis with multichannel SMS + Email"
  - "/ghl-cohort-analysis using Josh Wash proven workflow patterns"
category: reporting
...
---
# Cohort Analysis - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Cohort Analysis** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Cohort Analysis
...
Extract the user's goal from their input after `/ghl-cohort-analysis`.
...
If unclear, ask: "What would you like to accomplish with cohort analysis?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `cohort analysis multichannel automation best practices`
