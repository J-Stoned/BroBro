...
examples:
  - "/ghl-workflow-pause for appointment reminder automation"
  - "/ghl-workflow-pause with multichannel SMS + Email"
  - "/ghl-workflow-pause using Josh Wash proven workflow patterns"
category: workflow
...
---
# Workflow Pause - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Pause** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Pause
...
Extract the user's goal from their input after `/ghl-workflow-pause`.
...
If unclear, ask: "What would you like to accomplish with workflow pause?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow pause multichannel automation best practices`
