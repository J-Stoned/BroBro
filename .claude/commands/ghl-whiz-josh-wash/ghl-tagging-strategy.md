...
examples:
  - "/ghl-tagging-strategy for appointment reminder automation"
  - "/ghl-tagging-strategy with multichannel SMS + Email"
  - "/ghl-tagging-strategy using Josh Wash proven workflow patterns"
category: lead
...
---
# Tagging Strategy - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Tagging Strategy** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Tagging Strategy
...
Extract the user's goal from their input after `/ghl-tagging-strategy`.
...
If unclear, ask: "What would you like to accomplish with tagging strategy?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `tagging strategy multichannel automation best practices`
