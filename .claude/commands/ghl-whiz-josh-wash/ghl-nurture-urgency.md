...
examples:
  - "/ghl-nurture-urgency for appointment reminder automation"
  - "/ghl-nurture-urgency with multichannel SMS + Email"
  - "/ghl-nurture-urgency using Josh Wash proven workflow patterns"
category: lead
...
---
# Nurture Urgency - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Nurture Urgency** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Nurture Urgency
...
If unclear, ask: "What would you like to accomplish with nurture urgency?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `nurture urgency multichannel automation best practices`
