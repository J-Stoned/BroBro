...
examples:
  - "/ghl-tcpa-compliance for appointment reminder automation"
  - "/ghl-tcpa-compliance with multichannel SMS + Email"
  - "/ghl-tcpa-compliance using Josh Wash proven workflow patterns"
category: compliance
...
---
# Tcpa Compliance - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Tcpa Compliance** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Tcpa Compliance
...
Extract the user's goal from their input after `/ghl-tcpa-compliance`.
...
If unclear, ask: "What would you like to accomplish with tcpa compliance?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `tcpa compliance multichannel automation best practices`
