...
examples:
  - "/ghl-sequence-template for appointment reminder automation"
  - "/ghl-sequence-template with multichannel SMS + Email"
  - "/ghl-sequence-template using Josh Wash proven workflow patterns"
category: templates
...
---
# Sequence Template - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Sequence Template** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Sequence Template
...
Extract the user's goal from their input after `/ghl-sequence-template`.
...
If unclear, ask: "What would you like to accomplish with sequence template?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `sequence template multichannel automation best practices`
