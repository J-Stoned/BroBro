...
examples:
  - "/ghl-spam-complaint-handling for appointment reminder automation"
  - "/ghl-spam-complaint-handling with multichannel SMS + Email"
  - "/ghl-spam-complaint-handling using Josh Wash proven workflow patterns"
category: lead
...
---
# Spam Complaint Handling - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Spam Complaint Handling** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Spam Complaint Handling
...
If unclear, ask: "What would you like to accomplish with spam complaint handling?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `spam complaint handling multichannel automation best practices`
