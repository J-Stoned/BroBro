...
examples:
  - "/ghl-sms-automation for appointment reminder automation"
  - "/ghl-sms-automation with multichannel SMS + Email"
  - "/ghl-sms-automation using Josh Wash proven workflow patterns"
category: lead
...
---
# Sms Automation - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Sms Automation** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Sms Automation
...
If unclear, ask: "What would you like to accomplish with sms automation?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `sms automation multichannel automation best practices`
