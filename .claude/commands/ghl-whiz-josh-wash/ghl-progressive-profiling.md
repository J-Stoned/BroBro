...
examples:
  - "/ghl-progressive-profiling for appointment reminder automation"
  - "/ghl-progressive-profiling with multichannel SMS + Email"
  - "/ghl-progressive-profiling using Josh Wash proven workflow patterns"
category: content
...
---
# Progressive Profiling - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Progressive Profiling** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Progressive Profiling
...
Extract the user's goal from their input after `/ghl-progressive-profiling`.
...
If unclear, ask: "What would you like to accomplish with progressive profiling?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `progressive profiling multichannel automation best practices`
