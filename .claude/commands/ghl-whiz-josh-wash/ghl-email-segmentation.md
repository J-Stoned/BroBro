...
examples:
  - "/ghl-email-segmentation for appointment reminder automation"
  - "/ghl-email-segmentation with multichannel SMS + Email"
  - "/ghl-email-segmentation using Josh Wash proven workflow patterns"
category: lead
...
---
# Email Segmentation - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Email Segmentation** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Email Segmentation
...
If unclear, ask: "What would you like to accomplish with email segmentation?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `email segmentation multichannel automation best practices`
