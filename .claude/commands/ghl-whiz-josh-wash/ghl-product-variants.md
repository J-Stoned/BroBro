...
examples:
  - "/ghl-product-variants for appointment reminder automation"
  - "/ghl-product-variants with multichannel SMS + Email"
  - "/ghl-product-variants using Josh Wash proven workflow patterns"
category: ecommerce
...
---
# Product Variants - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Product Variants** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Product Variants
...
Extract the user's goal from their input after `/ghl-product-variants`.
...
If unclear, ask: "What would you like to accomplish with product variants?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `product variants multichannel automation best practices`
