...
examples:
  - "/ghl-delivery-confirmation for appointment reminder automation"
  - "/ghl-delivery-confirmation with multichannel SMS + Email"
  - "/ghl-delivery-confirmation using Josh Wash proven workflow patterns"
category: ecommerce
...
---
# Delivery Confirmation - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Delivery Confirmation** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Delivery Confirmation
...
Extract the user's goal from their input after `/ghl-delivery-confirmation`.
...
If unclear, ask: "What would you like to accomplish with delivery confirmation?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `delivery confirmation multichannel automation best practices`
