...
examples:
  - "/ghl-survey for appointment reminder automation"
  - "/ghl-survey with multichannel SMS + Email"
  - "/ghl-survey using Josh Wash proven workflow patterns"
category: lead
...
---
# Survey - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Survey** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Survey
...
If unclear, ask: "What would you like to accomplish with survey?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `survey multichannel automation best practices`
