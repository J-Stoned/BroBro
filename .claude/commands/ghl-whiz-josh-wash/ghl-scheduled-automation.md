...
examples:
  - "/ghl-scheduled-automation for appointment reminder automation"
  - "/ghl-scheduled-automation with multichannel SMS + Email"
  - "/ghl-scheduled-automation using Josh Wash proven workflow patterns"
category: workflow
...
---
# Scheduled Automation - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Scheduled Automation** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Scheduled Automation
...
Extract the user's goal from their input after `/ghl-scheduled-automation`.
...
If unclear, ask: "What would you like to accomplish with scheduled automation?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `scheduled automation multichannel automation best practices`
