...
examples:
  - "/ghl-email-template for appointment reminder automation"
  - "/ghl-email-template with multichannel SMS + Email"
  - "/ghl-email-template using Josh Wash proven workflow patterns"
category: templates
...
---
# Email Template - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Email Template** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Email Template
...
Extract the user's goal from their input after `/ghl-email-template`.
...
If unclear, ask: "What would you like to accomplish with email template?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `email template multichannel automation best practices`
