...
examples:
  - "/ghl-workflow-bulk-edit for appointment reminder automation"
  - "/ghl-workflow-bulk-edit with multichannel SMS + Email"
  - "/ghl-workflow-bulk-edit using Josh Wash proven workflow patterns"
category: workflow
...
---
# Workflow Bulk Edit - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Bulk Edit** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Bulk Edit
...
Extract the user's goal from their input after `/ghl-workflow-bulk-edit`.
...
If unclear, ask: "What would you like to accomplish with workflow bulk edit?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow bulk edit multichannel automation best practices`
