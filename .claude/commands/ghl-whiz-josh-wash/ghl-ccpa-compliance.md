...
examples:
  - "/ghl-ccpa-compliance for appointment reminder automation"
  - "/ghl-ccpa-compliance with multichannel SMS + Email"
  - "/ghl-ccpa-compliance using Josh Wash proven workflow patterns"
category: compliance
...
---
# Ccpa Compliance - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Ccpa Compliance** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Ccpa Compliance
...
Extract the user's goal from their input after `/ghl-ccpa-compliance`.
...
If unclear, ask: "What would you like to accomplish with ccpa compliance?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `ccpa compliance multichannel automation best practices`
