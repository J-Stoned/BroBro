...
examples:
  - "/ghl-webhook-receiver for appointment reminder automation"
  - "/ghl-webhook-receiver with multichannel SMS + Email"
  - "/ghl-webhook-receiver using Josh Wash proven workflow patterns"
category: workflow
...
---
# Webhook Receiver - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Webhook Receiver** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Webhook Receiver
...
Extract the user's goal from their input after `/ghl-webhook-receiver`.
...
If unclear, ask: "What would you like to accomplish with webhook receiver?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `webhook receiver multichannel automation best practices`
