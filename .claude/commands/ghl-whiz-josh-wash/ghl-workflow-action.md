...
examples:
  - "/ghl-workflow-action for appointment reminder automation"
  - "/ghl-workflow-action with multichannel SMS + Email"
  - "/ghl-workflow-action using Josh Wash proven workflow patterns"
category: workflow
...
---
# Workflow Action - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Workflow Action** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Workflow Action
...
Extract the user's goal from their input after `/ghl-workflow-action`.
...
If unclear, ask: "What would you like to accomplish with workflow action?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `workflow action multichannel automation best practices`
