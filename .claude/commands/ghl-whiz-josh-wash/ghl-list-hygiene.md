...
examples:
  - "/ghl-list-hygiene for appointment reminder automation"
  - "/ghl-list-hygiene with multichannel SMS + Email"
  - "/ghl-list-hygiene using Josh Wash proven workflow patterns"
category: lead
...
---
# List Hygiene - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **List Hygiene** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to List Hygiene
...
If unclear, ask: "What would you like to accomplish with list hygiene?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `list hygiene multichannel automation best practices`
