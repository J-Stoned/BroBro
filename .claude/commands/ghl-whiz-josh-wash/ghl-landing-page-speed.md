...
examples:
  - "/ghl-landing-page-speed for appointment reminder automation"
  - "/ghl-landing-page-speed with multichannel SMS + Email"
  - "/ghl-landing-page-speed using Josh Wash proven workflow patterns"
category: lead
...
---
# Landing Page Speed - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Landing Page Speed** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Landing Page Speed
...
If unclear, ask: "What would you like to accomplish with landing page speed?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `landing page speed multichannel automation best practices`
