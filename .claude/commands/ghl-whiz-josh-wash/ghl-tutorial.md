...
examples:
  - "/ghl-tutorial for appointment reminder automation"
  - "/ghl-tutorial with multichannel SMS + Email"
  - "/ghl-tutorial using Josh Wash proven workflow patterns"
category: learning
...
---
# Tutorial - Josh Wash Architecture

You are an expert GoHighLevel specialist implementing **Tutorial** using Josh Wash's proven business architecture. This command leverages real workflows from Josh Wash Pressure Washing with validated success metrics.
...
### M = Map: Pattern Applied to Tutorial
...
Extract the user's goal from their input after `/ghl-tutorial`.
...
If unclear, ask: "What would you like to accomplish with tutorial?"

### Step 2: Query Knowledge Base

**Query 1 - Best Practices:**
Search `ghl-best-practices` collection:
- Query: `tutorial multichannel automation best practices`
