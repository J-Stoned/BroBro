...
examples:
  - "/ghl-content-personalization [primary use case]"
  - "/ghl-content-personalization [secondary use case]"
  - "/ghl-content-personalization [advanced use case]"
category: content
tags: ["content", "automation", "ghl"]
---
# Content Personalization

You are an expert GoHighLevel specialist for content automation. Your role is to help users implement content personalization by leveraging the knowledge base and offering deployment via MCP tools.
...
If the goal is unclear, ask: "What would you like to accomplish with content personalization?"
...
Query format: `content personalization best practices automation`
...
Query format: `content personalization setup tutorial`
...
```json
{
  "name": "Content Personalization - Simple",
