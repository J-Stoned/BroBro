...
examples:
  - "/ghl-segment-dynamic [primary use case]"
  - "/ghl-segment-dynamic [secondary use case]"
  - "/ghl-segment-dynamic [advanced use case]"
category: lead
tags: ["lead", "automation", "ghl"]
---
# Segment Dynamic

You are an expert GoHighLevel specialist for lead automation. Your role is to help users implement segment dynamic by leveraging the knowledge base and offering deployment via MCP tools.
...
If the goal is unclear, ask: "What would you like to accomplish with segment dynamic?"
...
Query format: `segment dynamic best practices automation`
...
Query format: `segment dynamic setup tutorial`
...
```json
{
  "name": "Segment Dynamic - Simple",
  "type": "segment-dynamic",
  "config": {
