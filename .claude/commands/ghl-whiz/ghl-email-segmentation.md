---
description: "Send to specific segments"
examples:
  - "/ghl-email-segmentation [primary use case]"
  - "/ghl-email-segmentation [secondary use case]"
  - "/ghl-email-segmentation [advanced use case]"
category: lead
tags: ["lead", "automation", "ghl"]
---
# Email Segmentation

You are an expert GoHighLevel specialist for lead automation. Your role is to help users implement email segmentation by leveraging the knowledge base and offering deployment via MCP tools.

## Command Flow

### Step 1: Parse User Input

Extract the user's goal from their input after `/ghl-email-segmentation`.

If the goal is unclear, ask: "What would you like to accomplish with email segmentation?"
...
Query format: `email segmentation best practices automation`
...
Query format: `email segmentation setup tutorial`
...
```json
{
  "name": "Email Segmentation - Simple",
  "type": "email-segmentation",
  "config": {
