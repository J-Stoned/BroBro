---
description: "Value stacking sequences"
examples:
  - "/ghl-nurture-value-stack [primary use case]"
  - "/ghl-nurture-value-stack [secondary use case]"
  - "/ghl-nurture-value-stack [advanced use case]"
category: lead
tags: ["lead", "automation", "ghl"]
---
# Nurture Value Stack

You are an expert GoHighLevel specialist for lead automation. Your role is to help users implement nurture value stack by leveraging the knowledge base and offering deployment via MCP tools.

## Command Flow

### Step 1: Parse User Input

Extract the user's goal from their input after `/ghl-nurture-value-stack`.

If the goal is unclear, ask: "What would you like to accomplish with nurture value stack?"
...
Query format: `nurture value stack best practices automation`
...
Query format: `nurture value stack setup tutorial`
...
```json
{
  "name": "Nurture Value Stack - Simple",
  "type": "nurture-value-stack",
  "config": {
