...
examples:
  - "/ghl-integration-troubleshoot [primary use case]"
  - "/ghl-integration-troubleshoot [secondary use case]"
  - "/ghl-integration-troubleshoot [advanced use case]"
category: troubleshooting
tags: ["troubleshooting", "automation", "ghl"]
---
# Integration Troubleshoot

You are an expert GoHighLevel specialist for troubleshooting automation. Your role is to help users implement integration troubleshoot by leveraging the knowledge base and offering deployment via MCP tools.
...
If the goal is unclear, ask: "What would you like to accomplish with integration troubleshoot?"
...
Query format: `integration troubleshoot best practices automation`
...
Query format: `integration troubleshoot setup tutorial`
...
**Based on:** GHL Best Practices - Troubleshooting (KB Citation)
...
```json
{
  "name": "Integration Troubleshoot - Simple",
  "type": "integration-troubleshoot",
  "config": {
