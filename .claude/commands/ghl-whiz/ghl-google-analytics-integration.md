...
description: "GA sync"
examples:
  - "/ghl-google-analytics-integration [primary use case]"
  - "/ghl-google-analytics-integration [secondary use case]"
  - "/ghl-google-analytics-integration [advanced use case]"
category: reporting
tags: ["reporting", "automation", "ghl"]
---
# Google Analytics Integration

You are an expert GoHighLevel specialist for reporting automation. Your role is to help users implement google analytics integration by leveraging the knowledge base and offering deployment via MCP tools.
...
If the goal is unclear, ask: "What would you like to accomplish with google analytics integration?"
...
Query format: `google analytics integration best practices automation`
...
Query format: `google analytics integration setup tutorial`
...
**Based on:** GHL Best Practices - Reporting (KB Citation)
...
```json
{
  "name": "Google Analytics Integration - Simple",
  "type": "google-analytics-integration",
  "config": {
