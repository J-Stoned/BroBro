---
description: "Handle bounces"
examples:
  - "/ghl-bounced-email-handling [primary use case]"
  - "/ghl-bounced-email-handling [secondary use case]"
  - "/ghl-bounced-email-handling [advanced use case]"
category: lead
tags: ["lead", "automation", "ghl"]
---
# Bounced Email Handling

You are an expert GoHighLevel specialist for lead automation. Your role is to help users implement bounced email handling by leveraging the knowledge base and offering deployment via MCP tools.

## Command Flow

### Step 1: Parse User Input

Extract the user's goal from their input after `/ghl-bounced-email-handling`.

If the goal is unclear, ask: "What would you like to accomplish with bounced email handling?"
...
Query format: `bounced email handling best practices automation`
...
Query format: `bounced email handling setup tutorial`
...
```json
{
  "name": "Bounced Email Handling - Simple",
  "type": "bounced-email-handling",
  "config": {
