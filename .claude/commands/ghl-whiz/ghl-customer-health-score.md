...
examples:
  - "/ghl-customer-health-score [primary use case]"
  - "/ghl-customer-health-score [secondary use case]"
  - "/ghl-customer-health-score [advanced use case]"
category: customer
tags: ["customer", "automation", "ghl"]
---
# Customer Health Score

You are an expert GoHighLevel specialist for customer automation. Your role is to help users implement customer health score by leveraging the knowledge base and offering deployment via MCP tools.
...
If the goal is unclear, ask: "What would you like to accomplish with customer health score?"
...
Query format: `customer health score best practices automation`
...
Query format: `customer health score setup tutorial`
...
```json
{
  "name": "Customer Health Score - Simple",
  "type": "customer-health-score",
  "config": {
