...
examples:
  - "/ghl-google-sheets-integration [primary use case]"
  - "/ghl-google-sheets-integration [secondary use case]"
  - "/ghl-google-sheets-integration [advanced use case]"
category: integration
tags: ["integration", "automation", "ghl"]
---
# Google Sheets Integration

You are an expert GoHighLevel specialist for integration automation. Your role is to help users implement google sheets integration by leveraging the knowledge base and offering deployment via MCP tools.
...
If the goal is unclear, ask: "What would you like to accomplish with google sheets integration?"
...
Query format: `google sheets integration best practices automation`
...
Query format: `google sheets integration setup tutorial`
...
**Based on:** GHL Best Practices - Integration (KB Citation)
...
```json
{
  "name": "Google Sheets Integration - Simple",
