---
description: "Social proof sequences"
examples:
  - "/ghl-nurture-social-proof [primary use case]"
  - "/ghl-nurture-social-proof [secondary use case]"
  - "/ghl-nurture-social-proof [advanced use case]"
category: lead
tags: ["lead", "automation", "ghl"]
---
# Nurture Social Proof

You are an expert GoHighLevel specialist for lead automation. Your role is to help users implement nurture social proof by leveraging the knowledge base and offering deployment via MCP tools.

## Command Flow

### Step 1: Parse User Input

Extract the user's goal from their input after `/ghl-nurture-social-proof`.

If the goal is unclear, ask: "What would you like to accomplish with nurture social proof?"
...
Query format: `nurture social proof best practices automation`
...
Query format: `nurture social proof setup tutorial`
...
```json
{
  "name": "Nurture Social Proof - Simple",
  "type": "nurture-social-proof",
  "config": {
