...
export default function ParticlesBackground() {
  ...
  useEffect(() => {
    ...
    script.onload = () => {
      ...
      // observe changes from theme button (if you add dark mode later)
  ...
  return (
    <div
      ...
      style={{
        ...
        width: '100%',
        height: '100%',
        background: 'linear-gradient(to top right, rgb(227, 242, 253), rgb(144, 202, 249), rgb(100, 181, 246))',
        zIndex: -1,
        pointerEvents: 'none',
      }}
    />
